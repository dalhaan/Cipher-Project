...
public class GUI extends JPanel {
	...
	public static void main(String[] args) {
		...
		try {
			byte[] keyByte1 = Encryption.PasswordClass.hash(key, 128);
			byte[] keyByte2 = Encryption.PasswordClass.hash("password", 128);
			
			System.out.println("====== Hashing test ======");
			System.out.println("hash: "+Encryption.Encryptor.bytesToHex(keyByte1));
			System.out.println("hash: "+Encryption.Encryptor.bytesToHex(keyByte2));
			
			byte[] data = plaintext.getBytes();
			byte[] encryptedData = Encryption.Encryptor.encrypt(key, data);
			String encryptedText = Encryption.Encryptor.bytesToHex(encryptedData);
			System.out.println("====== Encrypting test ======");
			System.out.println("plaintext: "+plaintext);
			System.out.println("encrypted: "+encryptedText);
			System.out.println("extracted hash: "+Encryption.Encryptor.bytesToHex(Arrays.copyOfRange(encryptedData, 0, 16)));
			
			byte[] decryptedData = Encryption.Encryptor.decrypt(key, encryptedData);
